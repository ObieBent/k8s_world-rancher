...
rm -rf /shares/hauler/rancher-minimal
mkdir -p /shares/hauler/rancher-minimal
cd /shares/hauler/rancher-minimal
...
cat << EOF >> /shares/hauler/rancher-minimal/rancher-airgap-rancher-minimal.yaml
